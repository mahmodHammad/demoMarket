		...
		<Container sx={{ height: 'calc(100vh - 100px)' }}>
			...
			<Item md={6} center column>
				<Box maxWidth="370px" sx={{ textAlign: 'center' }} column>
					...
					<Box sx={{ mt: '24px' }}>
						<FormLabel sx={{ display: 'flex', fontSize: '12px', mb: '6px' }}>Full Name</FormLabel>
						...
						<FormLabel sx={{ display: 'flex', fontSize: '12px', mb: '6px', mt: '18px' }}>Phone Number</FormLabel>
					...
					<Button variant="contained" fullWidth size="large" sx={{ mt: '24px' }}>
						sign up
					</Button>
					<Text mt="24px">
